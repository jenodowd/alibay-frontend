    ...
    return (
      ...
      <div className="accountNav">
        <ul className="accountNavUL">
          ...
          {!this.props.name && <li className="accountNavLI"><button className="noButton" onClick={this.props.renderSignIn}>Login</button>or</li>}
          {!this.props.name && <li className="accountNavLI"><button className="noButton" onClick={this.props.renderSignUp}>Sign Up</button> &nbsp; </li>}
